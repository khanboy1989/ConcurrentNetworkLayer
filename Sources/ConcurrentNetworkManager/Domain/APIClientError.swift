...
///
/// This enum encapsulates various errors that may arise when performing network request, handling responses, or decoding data. Each case provides information aboit the nature of error.
///
...
/// - `decodingFailed(_ error: any Error)`: Decoding the response data failed, with the associated error providing details.
